...

  {
    ...
    output: {
      ...
      data: {
        ...
        lastVisit: {
          date: "18 Feb'26", vitals: "BP 148/92, Pulse 78",
          symptoms: "Headache (1wk, bilateral), Fatigue",
          examination: "Mild pedal edema", diagnosis: "Uncontrolled HTN, Metabolic syndrome",
          medication: "Amlodipine 5mg, Metformin 500mg, Atorvastatin 10mg",
          labTestsSuggested: "HbA1c, Lipid panel, KFT", advice: "Salt restriction, daily walk 30min",
          followUp: "4 weeks",
        },
...

  {
    ...
    output: {
      ...
      data: {
        ...
        totalPatients: 5,
        items: [
          { doctorName: "Dr. Arun Mehta", doctorPhone: "9876501122", specialty: "Cardiology", patientsReferred: 3, topReason: "Chest pain and HTN review" },
          { doctorName: "Dr. Sanjay Nair", doctorPhone: "9822207711", specialty: "Ophthalmology", patientsReferred: 2, topReason: "Retinopathy screening" },
        ],
      },
    },
  },
