  ...
  return (
    ...
    >
      ...
      <div className="mb-2">
        ...
        <div className="rounded-[6px] bg-tp-slate-50 px-2 py-[5px] text-[16px] leading-[1.6] text-tp-slate-600">
          {data.sourceText}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="rounded-[6px] bg-tp-success-50 px-2 py-[5px] text-[16px] leading-[1.6] text-tp-success-700">
          {data.translatedText}
        </div>
      </div>
    </CardShell>
